...
class ReturnOrderNotification extends Notification implements ShouldBroadcast
{
   ...
   */
  public function __construct(int $userId, string $requestRefundId,  string $message, int $isAdmin = 0)

  {
    $this->userId = $userId;
    $this->requestRefundId = $requestRefundId;
  ...
  public function toDatabase($notifiable)
  {
    return [
      'user_id' => $this->userId,
      'requestRefundId' => $this->requestRefundId,
