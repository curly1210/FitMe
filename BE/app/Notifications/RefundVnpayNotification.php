...
class RefundVnpayNotification extends Notification implements ShouldBroadcast
{
  use Queueable;
   ...
   */
  public function __construct(int $userId, string $orderId,  string $message, int $isAdmin = 0)
