...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cloudinary.cloud.cloud_name' => 'string',
            'cloudinary.cloud.api_key' => 'string',
            'cloudinary.cloud.api_secret' => 'string',
            'cloudinary.notification_url' => 'NULL',
            'cloudinary.cloud_url' => 'string',
            'cloudinary.upload_preset' => 'string',
            ...
            'filesystems.links.D:\laragon\www\FitMe\BE\public\storage' => 'string',
            'image.driver' => 'string',
...
'cache.stores.octane.driver','cache.prefix','cloudinary.cloud.cloud_name','cloudinary.cloud.api_key','cloudinary.cloud.api_secret',
'cloudinary.notification_url','cloudinary.cloud_url','cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\FitMe\\BE\\public\\storage',
...
'jwt.providers.auth','jwt.providers.storage','jwt.blacklist_storage','logging.default','logging.deprecations.channel',
...
'mail.admin_email','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'signed','throttle','verified','jwt.auth','role.admin',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','admin.orders.index',
'admin.orders.show','admin.orders.updateStatus','admincategories.index',
'admincategories.store','admincategories.show','admincategories.update','admincategories.destroy','adminbanners.index',
'adminbanners.getCategories','adminbanners.getPosts','adminbanners.getProducts','adminbanners.show','adminbanners.update',
'admin.products.index','admin.products.store','admin.products.update','admin.products.show','admin.products.trash',
'admin.products.restore','admin.products.delete','admin.products.destroy','admin.coupons.index','admin.coupons.store',
'admin.coupons.update','admin.coupons.delete','admin.','admin.posts.index','admin.posts.show',
'admin.posts.store','admin.posts.update','admin.posts.delete','comments.index',
'admin.comments.show','admin.comments.delete','admin.comments.toggleVisibility',
'reviews.getProductNeedReview','reviews.index','reviews.create','reviews.edit','reviews.update',
'reviews.index','reviews.index','reviews.hidden','addresses.index','addresses.store',
'addresses.show','addresses.update','addresses.destroy',
'posts.show','wishlist.index',
'wishlist.store','wishlist.destroy','wishlist.getImages','cart-items.index','cart-items.getAllItemsSelected',
'cart-items.store','cart-items.destroy','cart-items.update',
'cart-items.update',
'chatbot.test','chatbot.chat','chatbot.reset','storage.local',);
        registerArgumentsSet('views', 
'chatbot','emails.notify_admin_order','emails.order_confirmation','emails.resetpassword','welcome',
...
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.laragon.www.FitMe.BE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_ADMIN_EMAIL','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME',
'CLOUDINARY_CLOUD_NAME','CLOUDINARY_KEY','CLOUDINARY_SECRET','CLOUDINARY_URL','CLOUDINARY_UPLOAD_PRESET',
'JWT_SECRET','JWT_TTL','JWT_REFRESH_TTL','CACHE_DRIVER','REDIS_HOST',
'REDIS_PASSWORD','REDIS_PORT','VNP_TMNCODE','VNP_HASH_SECRET','VNP_URL',
'VNP_RETURN_URL','VNP_API_URL','API_URL','GHN_SHOP_ID','GHN_TOKEN',
'GHN_CLIENT_ID','OPENAI_API_KEY','GEMINI_API_KEY','REPLICATE_API_TOKEN',);
